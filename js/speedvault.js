...
$(document).ready(function() {
	...
	$('.svPlayer').prepend('<div class="meuVideo"> <iframe width="560" height="315" src="https://www.youtube.com/embed/unYQOvJrx_Y?showinfo=1&autoplay=0" frameborder="0" allowfullscreen></iframe> </div>');
